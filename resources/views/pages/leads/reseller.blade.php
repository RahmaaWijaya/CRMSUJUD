    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
             ...
             <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Reseller</h1>
            </div>
             <!-- Right: action  -->
             ...
             <div x-data="{ open: false }" class="relative inline-block text-left">
                    ...
                    <button @click="open = !open" class="bg-blue-500 text-white hover:bg-blue-600 rounded-t-md flex items-center w-full px-4 py-2">
                        <!-- Text -->
                        <span class="flex-1">Add Reseller</span>
                        <!-- Icon -->
                    ...
                    <div x-show="open" @click.away="open = false" class="origin-top-right absolute right-0 mt-1 w-full rounded-b-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-10" style="display: none;">
                        <div class="py-2" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                            <!-- Create Lead -->
                            <a href="{{ route('create-lead') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Create Reseller</a>
                            <!-- Import Leads -->
                            <a href="{{ route('import-leads')}}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Import Reseller</a>
                        </div>
                    </div>
                </div>
             </div>
        ...
        <div class="col-span-full xl:col-span-6 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
            <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60">
                <h2 class="font-semibold text-gray-800 dark:text-gray-100">Reseller</h2>
            </header>
            <div class="p-3">
